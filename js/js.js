window.js = {
    ...
    // Allows to keep, and to test online, codes written for external needs
    ...
    archive: {
                ...
                listen: () => {
                    window.onscroll = function() {
                        const yOffset = (
                            ...
                            ;
                        js.archive.user.scrollPercentage.value = Math.round(yOffset * 100 / bodyHeigth)
                    }
                }
            }
        },
        ...
        time: {
            ...
            getUtcInNumberOfDays: (days) => {
                return js.archive.time.getUtcFromTimestamp(
                    js.archive.time.getActualTimestamp() + js.archive.time.getDaysInMilliseconds(days)
                )
            }
        },
        cookie: {
